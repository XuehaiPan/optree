...
template <bool NoneIsLeaf, bool IsDictSorted, typename Span>
...
bool PyTreeSpec::FlattenIntoImpl(const py::handle& handle,
    ...
    if (leaf_predicate && py::cast<bool>((*leaf_predicate)(handle))) [[unlikely]] {
        ...
        auto recurse = [this, &found_custom, &leaf_predicate, &registry_namespace, &leaves, &depth](
            ...
            found_custom |= FlattenIntoImpl<NoneIsLeaf, IsDictSorted>(
...
bool PyTreeSpec::FlattenInto(const py::handle& handle,
    ...
    if (none_is_leaf) [[unlikely]] {
        if (IsDictSorted(registry_namespace)) [[likely]] {
            return FlattenIntoImpl<NONE_IS_LEAF, /*IsDictSorted=*/true>(
                handle, leaves, 0, leaf_predicate, registry_namespace);
        } else [[unlikely]] {
            return FlattenIntoImpl<NONE_IS_LEAF, /*IsDictSorted=*/false>(
                handle, leaves, 0, leaf_predicate, registry_namespace);
        }
    } else [[likely]] {
        if (IsDictSorted(registry_namespace)) [[likely]] {
            return FlattenIntoImpl<NONE_IS_NODE, /*IsDictSorted=*/true>(
                handle, leaves, 0, leaf_predicate, registry_namespace);
        } else [[unlikely]] {
            return FlattenIntoImpl<NONE_IS_NODE, /*IsDictSorted=*/false>(
                handle, leaves, 0, leaf_predicate, registry_namespace);
        }
    }
}
...
template <bool NoneIsLeaf, bool IsDictSorted, typename LeafSpan, typename PathSpan, typename Stack>
// NOLINTNEXTLINE[readability-function-cognitive-complexity]
bool PyTreeSpec::FlattenIntoWithPathImpl(const py::handle& handle,
    ...
    if (leaf_predicate && py::cast<bool>((*leaf_predicate)(handle))) [[unlikely]] {
        ...
        auto recurse = [this,
            ...
            found_custom |= FlattenIntoWithPathImpl<NoneIsLeaf, IsDictSorted>(
...
bool PyTreeSpec::FlattenIntoWithPath(const py::handle& handle,
    ...
    if (none_is_leaf) [[unlikely]] {
        if (IsDictSorted(registry_namespace)) [[likely]] {
            return FlattenIntoWithPathImpl<NONE_IS_LEAF, /*IsDictSorted=*/true>(
                handle, leaves, paths, stack, 0, leaf_predicate, registry_namespace);
        } else [[unlikely]] {
            return FlattenIntoWithPathImpl<NONE_IS_LEAF, /*IsDictSorted=*/false>(
                handle, leaves, paths, stack, 0, leaf_predicate, registry_namespace);
        }
    } else [[likely]] {
        if (IsDictSorted(registry_namespace)) [[likely]] {
            return FlattenIntoWithPathImpl<NONE_IS_NODE, /*IsDictSorted=*/true>(
                handle, leaves, paths, stack, 0, leaf_predicate, registry_namespace);
        } else [[unlikely]] {
            return FlattenIntoWithPathImpl<NONE_IS_NODE, /*IsDictSorted=*/false>(
                handle, leaves, paths, stack, 0, leaf_predicate, registry_namespace);
        }
    }
}
